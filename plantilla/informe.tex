...
de la fuente de datos ``agricultura.csv'' las técnicas de limpieza (Data
Wrangling)

El análisis se ha realizado utilizando el lenguaje de programación R
(version 4.5.2) bajo el entorno de desarrollo RStudio, empleando el
paradigma ``Tidyverse'' para la manipulación de datos.
...
experimental y lon gitudinal, dado que se analizan datos históricos
